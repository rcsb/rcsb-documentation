  ...
  return (
    <div>
      <div className="small-menu">
        <p>
          <i className="i-home brand-text" aria-hidden="true"></i>&nbsp;
          <a href={helpTopicsHref}
            style={{ opacity: isHomePage ? '50%' : '100%', pointerEvents: isHomePage ? 'none' : 'auto' }}>Help Topics</a>
          <span className="divider">|</span>

          <i className="fa fa-question-circle brand-text" aria-hidden="true"></i>&nbsp;
          <a href="/docs/general-help/website-faq">FAQs</a>
          <span className="divider">|</span>

          <i className="i-book brand-text" aria-hidden="true"></i>&nbsp;
